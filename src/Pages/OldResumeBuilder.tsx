      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-2/5 xl:w-1/3">
            <div className="bg-white text-black rounded-lg shadow-md sticky top-20 max-h-[calc(100vh-5rem)] overflow-y-auto">
...
export default OldResumeBuilder;